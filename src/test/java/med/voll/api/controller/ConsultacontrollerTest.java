...
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.post;  // o usa *
...
class ConsultacontrollerTest {
    ...
    @Test
    @DisplayName("Deberia devolver metodo http 400 cuando la request no tenga data")
    @WithMockUser
